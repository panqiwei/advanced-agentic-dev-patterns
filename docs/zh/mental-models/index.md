...
- [**因果**](ch-06-causality/index.md) — LLM 从统计共现中学习，它生活在相关性的海洋里。当你的应用需要因果性的可靠性时，系统需要因果纪律——迫使自己对"它知道什么"和"它怎么知道的"保持诚实。
- [**符号与联结**](ch-07-symbols-connectionism/index.md) — 符号系统擅长结构，神经网络擅长发现——两种不可互相还原的表征方式。Harness 是它们之间的翻译层，翻译有结构性的代价，代价沿一根张力轴分布。
