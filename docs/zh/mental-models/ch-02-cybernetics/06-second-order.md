...
- Bai, Y. et al. (2022). Constitutional AI: Harmlessness from AI Feedback. [arXiv:2212.08073](https://arxiv.org/abs/2212.08073). — 当系统观察自己：模型用原则批评自己的输出并自我训练，是二阶控制论在 AI 安全领域最完整的工程化实践
- Anthropic. (2025). Circuit Tracing: Revealing Computational Graphs in Language Models. [transformer-circuits.pub](https://transformer-circuits.pub/2025/attribution-graphs/methods.html). — 模型能否可靠地"看到"自己在做什么？这篇给出了目前最精细的实证数据

## 概念与实体

本文涉及的核心概念与实体，在项目知识库中有更详细的资料：

- [Mechanistic Interpretability](../../wiki/concepts/mechanistic-interpretability.md) — circuit tracing 所属的研究领域，追问模型内部计算的可观测性
- [Evaluator-Optimizer](../../wiki/concepts/evaluator-optimizer.md) — 分离原理在二阶视角下的张力：generator 和 evaluator 何时该分、何时可合
- [Harness Engineering](../../wiki/concepts/harness-engineering.md) — 二阶视角揭示 harness 设计是一个没有终点的迭代过程
- [Anthropic](../../wiki/entities/anthropic.md) — Constitutional AI 和 Circuit Tracing 的研究发布方
