...
Simon 与 [Allen Newell](allen-newell.md) 合作开发了 Logic Theorist（1956）和 General Problem Solver，是符号 AI 的奠基人之一。论文中"问题求解即搜索"的框架直接来自这些工作。

1976 年图灵奖讲座提出计算机科学最基本的定性结构律——[物理符号系统假说](../concepts/physical-symbol-system.md)：

> "一个物理符号系统具备通用智能行为的充分必要条件。"

配套提出[启发式搜索假说](../concepts/heuristic-search.md)：物理符号系统通过在[问题空间](../concepts/problem-space.md)中生成并递进修改符号结构来求解问题，核心技术是[手段-目的分析](../concepts/means-ends-analysis.md)。
